  ...
  module Helper
    module Type
      types = %w(
        ...
        iptables ip6tables json_file kernel_module linux_kernel_parameter
        libvirt_lxc lxc mail_alias mysql_config package php_config port ppa
        process routing_table selinux selinux_module service user yumrepo
